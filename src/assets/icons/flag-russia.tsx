...
const FlagRussia = (
	...
	<svg
		...
		{...props}
	>
		<rect fill={"url(#pattern0_73142_475)"} height={"20"} width={"20"} />
		<defs>
			<pattern
				height={"1"}
				id={"pattern0_73142_475"}
				patternContentUnits={"objectBoundingBox"}
				width={"1"}
			>
				<use transform={"scale(0.0138889)"} xlinkHref={"#image0_73142_475"} />
			</pattern>
			<image
				height={"72"}
				id={"image0_73142_475"}
...
export { ForwardRef as FlagRussia };
